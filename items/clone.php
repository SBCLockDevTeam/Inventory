    ...
    <?php if ($success): ?>
        <div class="success-banner">
            <?php if (count($cloned_items) === 1): ?>
                ...
                <a href="<?php echo BASE_PATH; ?>/items/view.php?id=<?php echo htmlspecialchars($cloned_items[0]['code']); ?>" class="btn btn-primary">View New Item</a>
            <?php else: ?>
                ...
                <ul>
                    <?php foreach ($cloned_items as $ci): ?>
                        <li>
                            ...
                            — <a href="<?php echo BASE_PATH; ?>/items/view.php?id=<?php echo htmlspecialchars($ci['code']); ?>">View</a>
                        </li>
                    <?php endforeach; ?>
                </ul>
            <?php endif; ?>
