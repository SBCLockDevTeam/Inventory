...
<body>
    ...
    <div class="body-content">
        ...
        <div class="item-actions">
            <a href="<?php echo BASE_PATH; ?>/items/edit.php?id=<?php echo $item['public_code']; ?>" class="btn btn-primary">Edit Item</a>
            <a href="<?php echo BASE_PATH; ?>/items/clone.php?id=<?php echo $item['public_code']; ?>" class="btn btn-secondary">Clone Item</a>
            <a href="<?php echo BASE_PATH; ?>/items/delete.php?id=<?php echo $item['public_code']; ?>" class="btn btn-danger">Delete Item</a>
            <a href="<?php echo BASE_PATH; ?>/items/" class="btn btn-secondary">Back to Items</a>
        </div>
            ...
            <table class="children-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            <a href="<?php echo BASE_PATH; ?>/items/view.php?id=<?php echo $child['public_code']; ?>" class="btn btn-small">View</a>
                            <a href="<?php echo BASE_PATH; ?>/items/edit.php?id=<?php echo $child['public_code']; ?>" class="btn btn-small">Edit</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
